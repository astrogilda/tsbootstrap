...
class TestBatchOptimizedBlockBootstrap:
    ...
    def test_initialization(self):
        ...
        bootstrap = BatchOptimizedBlockBootstrap(n_bootstraps=10, block_length=5, batch_size=5)
    ...
    def test_bootstrap_generation(self):
        ...
        bootstrap = BatchOptimizedBlockBootstrap(
            n_bootstraps=6, block_length=10, batch_size=3, rng=42
        )
    ...
    def test_batch_size_effect(self):
        ...
        bootstrap1 = BatchOptimizedBlockBootstrap(
            n_bootstraps=4, block_length=5, batch_size=2, rng=42
        )

        # Large batch size
        bootstrap2 = BatchOptimizedBlockBootstrap(
            n_bootstraps=4, block_length=5, batch_size=4, rng=42
        )
    ...
    def test_multivariate_data(self):
        ...
        bootstrap = BatchOptimizedBlockBootstrap(n_bootstraps=5, block_length=10, batch_size=5)
...
class TestBatchOptimizedModelBootstrap:
    ...
    def test_initialization(self):
        ...
        bootstrap = BatchOptimizedModelBootstrap(
            n_bootstraps=10, model_type="ar", order=2, batch_size=5
        )
    ...
    def test_bootstrap_generation(self):
        ...
        X = np.random.randn(100)
        bootstrap = BatchOptimizedModelBootstrap(
            n_bootstraps=4, model_type="ar", order=2, batch_size=2, rng=42
        )
    ...
    def test_different_models(self):
        ...
        ar_bootstrap = BatchOptimizedModelBootstrap(
            n_bootstraps=2, model_type="ar", order=1, batch_size=2
        )
        ...
        arima_bootstrap = BatchOptimizedModelBootstrap(
            n_bootstraps=2, model_type="arima", order=(0, 0, 1), batch_size=2  # Pure MA(1) model
        )
