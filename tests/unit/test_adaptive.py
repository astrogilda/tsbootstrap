...
def test_aci_recovers_coverage_under_distribution_shift():
...
def test_aci_gamma_zero_is_static():
...
def test_nexcp_decay_one_is_empirical_quantile():
...
def test_nexcp_recency_surfaces_recent_volatility():
