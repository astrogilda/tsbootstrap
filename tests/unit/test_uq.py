...
def test_fit_predict_oob_recovers_signal():
...
def test_enbpi_coverage_is_near_nominal_in_sample():
    LinearRegression = pytest.importorskip("sklearn.linear_model").LinearRegression
...
def test_enbpi_rejects_recursive_method():
    LinearRegression = pytest.importorskip("sklearn.linear_model").LinearRegression
...
def test_forecast_intervals_shape_and_determinism():
    x = _ar1(0.6, 200, 3)
