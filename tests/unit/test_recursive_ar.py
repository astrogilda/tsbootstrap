...
def test_one_shock_propagates_ar1():
...
def test_one_shock_propagates_ar2():
...
def test_residual_bootstrap_shape_and_determinism():
    x = _ar1(0.6, 300, 1)
...
def test_recursive_bootstrap_preserves_ar_dependence():
...
def test_bootstrap_coefficient_centers_on_fit():
    x = _ar1(0.7, 500, 4)
