...
def test_white_noise_recommends_iid():
...
def test_dependent_series_recommends_block():
...
def test_random_walk_flagged_nonstationary():
...
def test_multivariate_recommends_var():
