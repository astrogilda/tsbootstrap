...
def test_difference_integrate_roundtrip(d):
...
def test_arima_shape_and_determinism():
...
def test_arima_initial_levels_are_fixed():
...
def test_arma_d0_preserves_dependence():
...
def test_integrated_drift_is_reproduced():
