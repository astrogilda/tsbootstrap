...
def test_var_shape_and_determinism():
    x = _var1(300, 1)
...
def test_var_requires_multivariate():
...
def test_var_preserves_cross_correlation():
    x = _var1(500, 2)
...
def test_var_stability_helpers():
...
def test_var_unstable_fit_raises():
